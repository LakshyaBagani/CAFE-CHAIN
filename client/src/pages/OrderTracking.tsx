          ...
          <div className="space-y-8">
            {orders.map((order, orderIndex) => {
              ...
              return (
                <div 
                  key={order.id} 
                  className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-orange-100/50 p-8 hover:shadow-2xl transition-all duration-300 hover:scale-[1.02]"
